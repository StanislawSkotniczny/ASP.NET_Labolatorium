...
namespace Labolatorium_5_EF.Controllers
{
    public class ContactEntitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Birth")] ContactEntity contactEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Birth")] ContactEntity contactEntity)
        {
